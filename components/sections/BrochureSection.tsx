  ...
  return (
    <section className="py-20 bg-white border-b border-[#D8F3DC]">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-[#F7F9F7]/40 rounded-3xl p-8 lg:p-12 border border-[#2D6A4F]/20">
          ...
          <div className="lg:col-span-7 flex flex-col gap-5">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 mt-4">
              <button
                ...
                className="w-full sm:w-auto h-11 bg-[#2D6A4F] hover:bg-[#2D6A4F] text-white text-xs font-bold rounded-full px-6 flex items-center justify-center gap-2 transition-colors shadow-md"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto h-11 border-2 border-[#1B4332] text-[#1B4332] hover:bg-[#F7F9F7] text-xs font-bold rounded-full px-6 flex items-center justify-center gap-2 transition-colors"
              >
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div
              onClick={triggerBrochureModal}
              className="relative w-full max-w-xs aspect-[1/1.4] rounded-xl border border-[#2D6A4F]/25 bg-white shadow-lg overflow-hidden group cursor-pointer hover:shadow-xl transition-all hover:scale-[1.01]"
            >
              {/* Outer frame border */}
              <div className="absolute top-0 left-0 w-full h-full bg-slate-50 opacity-10 bg-[radial-gradient(#2D6A4F_1.5px,transparent_1.5px)] [background-size:16px_16px] pointer-events-none" />
              ...
              <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-between p-6 z-10">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[9px] font-bold bg-[#F7F9F7] text-[#2D6A4F] px-2 py-0.5 rounded border border-[#2D6A4F]/20">
                    Edition 2026
                  </span>
                </div>

                <div className="my-auto flex flex-col gap-2 py-8 text-center items-center">
                  <span className="text-[10px] font-bold tracking-widest uppercase text-[#2D6A4F]">
                    Plentra Exports Ltd
                  </span>
                  <h4 className="font-serif text-2xl font-bold text-[#0F2D1E] leading-tight">
                    Corporate Profile
                  </h4>
                  <p className="text-[10px] text-[#40916C] font-sans max-w-[180px]">
                    Sourcing parameters, trade logistics, and certification matrix.
                  </p>
                </div>

                <div className="flex justify-between items-center border-t border-[#D8F3DC] pt-4 text-[9px] font-semibold text-[#40916C] uppercase tracking-wider">
              ...
              {/* Hover screen */}
              <div className="absolute inset-0 bg-[#2D6A4F]/8 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center z-20">
                <span className="px-4 py-2 bg-white/95 border border-[#2D6A4F]/25 rounded-full font-bold text-[10px] tracking-wider uppercase shadow-md flex items-center gap-1.5 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300 text-[#1B4332]">
